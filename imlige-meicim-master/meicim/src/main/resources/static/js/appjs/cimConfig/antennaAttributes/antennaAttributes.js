var prefix = "/cimConfig/antennaAttributes"
$(function () {
    load();
});
        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'horizontalHPBW',
                        title: 'horizontalHPBW'
                    },
                    {
                        field: 'verticalHPBW',
                        title: 'verticalHPBW'
                    ...
                    {
                        field: 'presetDownTilt',
                        title: 'presetDownTilt'
                    },
                    {
                        field: 'isElectrical',
                        title: 'isElectrical'
                    ...
                    {
                        field: 'electricalDownTiltRange',
                        title: 'electricalDownTiltRange'
                    },
                    {
                        field: 'isSmart',
                        title: 'isSmart'
