var prefix = "/cimConfig/cableDefinitions"
$(function () {
    load();
});
        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'minTurningRadius',
                        title: 'minTurningRadius'
                    },
                    {
                        field: 'crossShapeType',
                        title: 'crossShapeType'
                    },
                    {
                        field: 'sideLengthArray',
                        title: 'sideLengthArray'
                    },
                    {
                        field: 'coreArray',
                        title: 'coreArray'
                    ...
                    {
                        field: 'coreCrossSectionAreas',
                        title: 'coreCrossSectionAreas'
                    },
                    {
                        field: 'jointModels',
                        title: 'jointModels'
                    ...
                    {
                        field: 'centerLocations',
                        title: 'centerLocations'
                    },
                    {
                        field: 'width',
                        title: 'width'
